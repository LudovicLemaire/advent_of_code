...
func reducedAtoi(str string) int {
...
func ex01() int {
	...
	for _, pair := range pairs {
		...
		if startSectionElf1 >= startSectionElf2 && endSectionElf1 <= endSectionElf2 {
			duplicate++
		} else if startSectionElf2 >= startSectionElf1 && endSectionElf2 <= endSectionElf1 {
			duplicate++
		}
	}
	return duplicate
